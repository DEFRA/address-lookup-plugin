/**
 * Translator for use within postcode-lookup plugin.
 ...
 *   error: (_err: unknown, _text: string) => void
 * }} Logger
 */
...
/**
 * @typedef {{ query: Record<string, string>, yar: Yar }} GenericRequest
 */
 ...
 * @typedef {Request<PostcodeLookupPostRequestRefs> & GenericRequest} PostcodeLookupPostRequest
